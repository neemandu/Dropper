...
namespace MarketplaceWebServiceOrders {
    ...
    public class MarketplaceWebServiceOrdersSample {
        public MarketplaceWebServiceOrdersSample() { }
        public void Activate()
        {
            // TODO: Set the below configuration variables before attempting to run

            // Developer AWS access key
            string accessKey = "AKIAIRRXL6D7ELLZPAFA";

            // Developer AWS secret key
            string secretKey = "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";
        ...
        public GetOrderResponse InvokeGetOrder()
        {
            ...
            string sellerId = "A2MYXT7L2V7JQC";
            request.SellerId = sellerId;
            string mwsAuthToken = "example";
            request.MWSAuthToken = mwsAuthToken;
            List<string> amazonOrderId = new List<string>() { "111-5045332-7759430" };
